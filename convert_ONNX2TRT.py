...
# Fix batch_size
def main_fixed(onnx_file_path,engine_file_path,batch_size):
...
if __name__ == "__main__":
    ...
    batch_size = 1
    onnx_file_path = "weight/best.onnx"
    engine_file_path = "weight/best.trt"
    
    main_fixed(onnx_file_path,engine_file_path,batch_size)